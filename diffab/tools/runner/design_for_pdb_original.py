...
def design_for_pdb(args):
    ...
    for variant in data_variants:
        ...
        save_pdb(data_native, os.path.join(log_dir, 'REF1.pdb'))
...
def args_from_cmdline():
    ...
    parser.add_argument('--antigen', type=str, default=None, help='Chain id of the light chain.')
    parser.add_argument('--pdb_code',type=str, default=None, help='Pdb code')
    parser.add_argument('--no_renumber', action='store_true', default=True)
